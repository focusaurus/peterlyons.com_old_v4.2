...
rsync -iEz${1} /etc/init.d/webware_peterlyons.com /etc/init.d/spawn-fcgi_peterlyons.com "${HOST}:/etc/init.d"
rsync -iEz${1} /etc/nginx/sites-available/peterlyons.com "${HOST}:/etc/nginx/sites-available"
rsync -iEz${1} /etc/nginx/sites-enabled/001-peterlyons.com "${HOST}:/etc/nginx/sites-enabled"
